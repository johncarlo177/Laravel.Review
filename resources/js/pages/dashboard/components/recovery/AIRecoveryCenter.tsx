...
export const AIRecoveryCenter: React.FC = () => {
  ...
  const [tickets, setTickets] = useState(MOCK_RECOVERY_TICKETS);
  ...
  if (currentTicketId) {
    return (
      <RecoveryConversationView
        ...
        setRoute={setCurrentTicketId}
        updateTicket={updateTicket}
      />
    );
  }

  return <RecoveryInboxView tickets={tickets} stats={MOCK_RECOVERY_STATS} setRoute={setCurrentTicketId} />;
};

const RecoveryInboxView = ({ tickets, stats, setRoute }: {
